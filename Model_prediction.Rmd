...
# 8 day spring 2019
df_Spring_8D_2019 <- arrow::read_feather('Aug_2021_LineP.feather')
...
# Spring 8D 2019
Predictions_Spring_8D_2019 <- predict(model1, df_Summer_8D_2021, type = "response")
Predictions_Spring_8D_2019  <- as.data.frame(Predictions_Summer_8D_2021)  # Create a data frame of predictions
