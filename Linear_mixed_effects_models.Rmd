...
# total_data <- read.csv("Total_Sat_Data2.csv")
# total_data <- read.csv("Total_Sat_Data_Spring.csv")
...
# model1 <- lm(TEP ~ Log_Chl + Temperature, data = UpperMixed_data)
