...
df <- arrow::read_feather('May_2021_LineP.feather')

```

# Make predictions on the python Satellite dataframe:
```{r}
Predictions <- predict(model1, df, type = "response")
Predictions <- as.data.frame(Predictions)  # Create a data frame of predictions

# Save the predictions back into a feather file, to be imported back into python:
feather::write_feather(Predictions, 'May_2021_LineP_Predictions.feather')
