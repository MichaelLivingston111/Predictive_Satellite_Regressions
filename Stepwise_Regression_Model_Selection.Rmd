...
UpperMixed_data <- total_data %>% select(TEP, Temperature, Nitrate, DO, MLD, Season, Avg_PAR, Silicate, Log_Chl)
...
# Fit a regression model and use LOOCV to evaluate performance on the 'forwards' model:
forwards <- train(TEP ~ Log_Chl + Temperature + DO + Nitrate + factor(Season), data = UpperMixed_data,
               method = "lm", trControl = ctrl)
print(forwards)

# Fit a regression model and use LOOCV to evaluate performance on the 'backwards' model:
backwards <- train(TEP ~ Log_Chl + Temperature + DO + factor(Season), data = UpperMixed_data,
               method = "lm", trControl = ctrl)
print(backwards)

# Fit a regression model and use LOOCV to evaluate performance on the 'optimal' model:
optimal <- train(TEP ~ Log_Chl + Temperature + DO + Season, data = UpperMixed_data,
               method = "lm", trControl = ctrl)
print(optimal)
summary(optimal)
