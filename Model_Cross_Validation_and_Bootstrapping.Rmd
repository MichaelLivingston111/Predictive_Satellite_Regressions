...
predictions <- cbind(sample_predict, sample_predict_2, sample_predict_3, sample_predict_4, sample_predict_5, sample_predict_6, sample_train)
...
Model1 <- ggplot(predictions, aes(sample_train)) +
...
Model2 <- ggplot(predictions, aes(sample_train)) +
  geom_point(aes(y = sample_predict_2), alpha = 0.6) +
  geom_abline(slope = 1, intercept = 0, linetype = "dashed") +  # Add a 1:1 line
  #geom_smooth(method = 'lm', aes(y = sample_predict_2)) +
  xlab("") +
  ylab("") +
  ggtitle("Log_Chl + Nitrate") +
  xlim(0, 150) +
  ylim(0, 150) +
  theme_classic()

Model3 <- ggplot(predictions, aes(sample_train)) +
  geom_point(aes(y = sample_predict_3), alpha = 0.6) +
  geom_abline(slope = 1, intercept = 0, linetype = "dashed") +  # Add a 1:1 line
  #geom_smooth(method = 'lm', aes(y = sample_predict_3)) +
  xlab("") +
  ylab("") +
  ggtitle("Log_Chl + Nitrate + DO + factor(Season)") +
  xlim(0, 150) +
  ylim(0, 150) +
  theme_classic()

Model4 <- ggplot(predictions, aes(sample_train)) +
  geom_point(aes(y = sample_predict_4), alpha = 0.6) +
  geom_abline(slope = 1, intercept = 0, linetype = "dashed") +  # Add a 1:1 line
  #geom_smooth(method = 'lm', aes(y = sample_predict_4)) +
  xlab("") +
  ylab("") +
  ggtitle("MLD + Nitrate + DO") +
  xlim(0, 150) +
  ylim(0, 150) +
  theme_classic()

Model5 <- ggplot(predictions, aes(sample_train)) +
  geom_point(aes(y = sample_predict_5), alpha = 0.6) +
  geom_abline(slope = 1, intercept = 0, linetype = "dashed") +  # Add a 1:1 line
  #geom_smooth(method = 'lm', aes(y = sample_predict_4)) +
  xlab("") +
  ylab("") +
  ggtitle("Log_Chl + Temp + (1|Season)") +
  xlim(0, 150) +
  ylim(0, 150) +
  theme_classic()

Model6 <- ggplot(predictions, aes(sample_train)) +
  geom_point(aes(y = sample_predict_6), alpha = 0.6) +
  geom_abline(slope = 1, intercept = 0, linetype = "dashed") +  # Add a 1:1 line
  #geom_smooth(method = 'lm', aes(y = sample_predict_4)) +
  xlab("") +
  ylab("") +
  ggtitle("Log_Chl + Temp + Nitrate + DO + (1|Season)") +
  xlim(0, 150) +
  ylim(0, 150) +
  theme_classic()

ggarrange(Model1, Model2, Model3, Model4, Model5, Model6, ncol = 2, nrow = 3)
```
