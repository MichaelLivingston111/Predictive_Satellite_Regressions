...
# Create a set of 'Prediction functions'. These functions will take large data sets as an input, and return the predictions made by the model. The model was validated and selected in the repository titled "Model_Selection":
