...
Chl_Temp_POC_Bloom_LM = lm(TEP ~ Temperature + Log_Chl + POC + Bloom, 
                   data = global_data)  # Chl, Temp, Bloom, POC
...
# Apply the functions to caluclate and visualize accuracy metrics:
